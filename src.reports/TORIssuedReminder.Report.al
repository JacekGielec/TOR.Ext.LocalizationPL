report 50454 "TOR Issued Reminder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src.reports/TORIssuedReminder.rdlc';
    Caption = 'Reminder';
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            column(Responsible_Person_Mail; "Responsible Person Mail")
            {
                IncludeCaption = true;
            }
            column(Responsible_Person_Phone_No_; "Responsible Person Phone No.")
            {
                IncludeCaption = true;
            }
            column(Resp__Person_Mobile_Phone_No_; "Resp. Person Mobile Phone No.")
            {
                IncludeCaption = true;
            }
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Issued Reminder Line"; "Issued Reminder Line")
                {
                    ...
                    column(QtyDays; CalcDays("Due Date"))
                    {
    ...
    begin
        ...
        CreateDate := CreateDateTime(WorkDate(), time());
    ...
    local procedure CalcDays(DueDate: Date): Integer;
    begin
        if ("Issued Reminder Header"."Document Date" <> 0D) and (DueDate <> 0D) then
            EXIT("Issued Reminder Header"."Document Date" - DueDate);
    end;
