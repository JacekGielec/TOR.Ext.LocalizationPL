report 50458 "TOR Sales - Shipment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src.reports/TORPostedSalesShipment.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(LocationCode_SalesShptLineCaption; FieldCaption("location code"))
                        {
                        }
                        column(LocationCode_SalesShptLine; "location code")
                        {
                        }
    ...
    begin
        ...
        user.SetRange("User Name", "Sales Shipment Header"."User ID");
