report 50457 "TOR Posted Cash Withdrawal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src.reports/TORPostedCashWithdrawal.rdlc';

    Caption = 'TOR Posted Cash Withdrawal';
    ...
    var
        ...
        ReportTitleLbl: Label 'The cash pays';
        WhoPayLbl: Label 'Pay for:';
        DebitLbl: Label 'Debit';
        CreditLbl: Label 'Credit';
        CashLbl: Label 'Cash';
        AccountLbl: Label 'Account';
        CreatedByLbl: Label 'Created by';
        PayByLbl: Label 'I received the above amount';
        ShowDetails: Boolean;
        Copies: Integer;
