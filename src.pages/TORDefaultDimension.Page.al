page 50452 "TOR Default Dimensions"
{
    Caption = 'TOR Default Dimensions';
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(AllowedValuesFilter; Rec."Allowed Values Filter")
                {
                    ...
                    begin
                        if Rec."Value Posting" = "Default Dimension Value Posting Type"::"Code Mandatory" then begin
                            CurrPage.SaveRecord();
    ...
    begin
        IsAllowedValuesFilterEditable := Rec."Value Posting" = "Default Dimension Value Posting Type"::"Code Mandatory";
    end;
